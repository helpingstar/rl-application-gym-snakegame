...
class Args:
    ...
    wandb_project_name: str = "snakegame_size10"
    ...
    env_id: str = "gym_snakegame/SnakeGame-v0"
    ...
    log_losses_interval: int = 200
    """Record interval for losses"""
    record_interval: int = 2000
...
class Agent(nn.Module):
    def __init__(self, envs):
        ...
        self.network = nn.Sequential(
            layer_init(nn.Conv2d(args.n_channel, 32, 3)),
            nn.ReLU(),
            ...
            nn.ReLU(),
            nn.Flatten(),
            layer_init(nn.Linear(128 * 4 * 4, 2048)),
            nn.ReLU(),
        )
